...
<%--		<jsp:include page="aside.jsp"></jsp:include>--%>
		...
		<div class="content-wrapper">
			...
			<h1>
				联系人管理 <small>添加联系人</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/main.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/cust/getall">联系人列表</a></li>
				<li class="active">联系人</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="/linkman_add"
				method="post">
				<!-- 正文区域 -->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="备注" name="lkmMemo"></textarea>
						</div>
