...
<%--		<jsp:include page="aside.jsp"></jsp:include>--%>
		...
		<div class="content-wrapper">
			...
			<h1>
				部门管理 <small>部门信息更新</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/main.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/department/list">部门列表</a></li>
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="sn"
								placeholder="部门名称" value="${department.sn}" readonly="readonly">
						</div>

						<div class="col-md-2 title">部门名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="name"
								   placeholder="客户名称" value="${department.name}" >
						</div>



						<div class="col-md-2 title">部门地址</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="address"
								   placeholder="客户名称" value="${department.address}" >
						</div>
