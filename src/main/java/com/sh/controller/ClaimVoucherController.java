...
//        返回到详情页面
    ...
    public String self(HttpSession session, Map<String,Object> map){
        ...
        List<ClaimVoucher> lists= claimVoucherBiz.getForSelf(employee.getSn());
        for (ClaimVoucher claimVoucher : lists) {
